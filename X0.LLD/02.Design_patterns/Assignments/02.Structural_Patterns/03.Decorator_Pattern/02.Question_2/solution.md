...
class PumpkinSpiceDecorator extends CoffeeAddons{
    ...
    @Override
    public String create(){
      return super.create() + " with pumpkin spices";
    }
}


class PeppermintDecorator extends CoffeeAddons{
    public PeppermintDecorator(Coffee coffee){
      super(coffee);
    }

    @Override
    public String create(){
      return super.create() + " with peppermint";
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        Coffee coffee4 = new PumpkinSpiceDecorator(new BasicCoffee());
        System.out.println(coffee4.create());

        Coffee coffee5 = new PeppermintDecorator(new BasicCoffee());
        System.out.println(coffee5.create());
    }
}
```
